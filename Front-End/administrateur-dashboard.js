...
function renderDashboard(data) {
        ...
        card.innerHTML = `
            <div>
                ...
                <div class="flex flex-col lg:flex-row items-stretch lg:items-center gap-4 text-sm mb-5">
                    ...
                    <!-- Right: Manage Button Align -->
                    <div class="flex items-end justify-end shrink-0">
                        <button onclick="viewElectionRequests('${election.id}', '${escapeHtml(election.titre)}')"
            ...
            <div>
                ...
                <!-- Action Buttons: Depouiller ou Voir résultats -->
    ...
    document.querySelectorAll(".dep-launch-btn").forEach((btn) => {
        btn.addEventListener("click", () => {
            const id = btn.dataset.eid; // On garde le format original (String ou Int)
    ...
    document.querySelectorAll(".see-results-btn").forEach((btn) => {
        btn.addEventListener("click", () => {
            const id = btn.dataset.eid; // On garde le format original sans forcer le parseInt
